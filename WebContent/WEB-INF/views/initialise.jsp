         ...
         <div class="card card-outline-secondary">
          ...
          <div class="card-body">
            <div id="initialise_div" style="display:none;">
			  ...
			  <div class="form-group row row-bottom-margin ml-2" style="margin-bottom:5px;">
			    ...
			    <div class="col-sm-6 col-md-6">
			      <select id="select_broadcaster" name="select_broadcaster" class="browser-default custom-select custom-select-sm"
			      		...
			      		<option value="ICC_U19_WORLDCUP_2024">ICC_U19_WorldCup_2024</option>
			      </select>
			    </div>
			  </div>
			  ...
			  <div class="form-group row row-bottom-margin ml-2" style="margin-bottom:5px;">
			    <label for="select_audio" class="col-sm-4 col-form-label text-left">Audio</label>
			    <div class="col-sm-6 col-md-6">
			    ...
			    <div class="form-group row row-bottom-margin ml-2" style="margin-bottom:5px;">
			    <label for="wagon" class="col-sm-4 col-form-label text-left">Wagon </label>
			    <div class="col-sm-6 col-md-6">
			      <select id="wagon" name="wagon" value="${session_configuration.wagon}" class="browser-default custom-select custom-select-sm"
			      		onchange="processUserSelection(this)">
			      		<option value="With_Wagon">With Wagon</option>
			      		<option value="WithOut_Wagon">Without Wagon</option>
			      </select>
			    </div>
			  </div>
			  
			    <div class="form-group row row-bottom-margin ml-2" style="margin-bottom:5px;">
			    <label for="qudich" class="col-sm-4 col-form-label text-left"> QT</label>
			    <div class="col-sm-6 col-md-6">
			      <select id="qudich" name="qudich" value="${session_configuration.qudich}" class="browser-default custom-select custom-select-sm"
			      		onchange="processUserSelection(this)">
			      		<option value="With_QT">With QT</option>
			      		<option value="WithOut_QT">Without QT</option>
			      </select>
			    </div>
			  </div>
