...
function initialiseForm(whatToProcess,dataToProcess)
{
	...
	case 'UPDATE-CONFIG':
		...
		document.getElementById('qudich').value = dataToProcess.qudich;
		document.getElementById('wagon').value = dataToProcess.wagon;
...
function processUserSelectionData(whatToProcess,dataToProcess){
	...
	case 'LOGGER_FORM_KEYPRESS':
		...
		case 'DOAD_FRUIT': case 'ICC_U19_WORLDCUP_2024':
...
function processCricketProcedures(whatToProcess)
{
	...
	case 'POPULATE-FRUIT':
		...
		case 'DOAD_FRUIT':
			...
			break;
		case 'ICC_U19_WORLDCUP_2024' :
		//alert($('#selected_broadcaster').val());
			valueToProcess = 'D:/DOAD_In_House_Everest/Everest_Cricket/ICC_U19_WprldCup_2024/Scenes/Fruit.sum';
			break;
		}
		break;
	}
